...
namespace Version3
{
    public partial class NewRepeaterTest : Form
    {
        public NewRepeaterTest()
        {
            InitializeComponent();          
        }
        ...
        public void bindgrid()
        {
            ...
            string sql = " SELECT  * from mimdist.dbo.m_app_po_release    ";
            ...
            else
            {
                ...
                sql = sql + " ORDER BY  due_date Asc   SELECT sum([quantity]) as tot_quantity, sum([received]) as tot_received   FROM [MIMDIST].[dbo].[m_app_po_release]  ";
